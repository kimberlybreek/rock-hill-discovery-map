window.REGION = {
  ...
  landmarks: [
    ...
    { lat: 35.0068, lon: -80.9435, name: 'Parking', type: 'parking' },
    { lat: 34.9975, lon: -80.9265, name: 'Parking', type: 'parking' },
    { lat: 35.0148, lon: -80.9610, name: 'Parking', type: 'parking' },
  ],
  ...
  places: [
    ...
    { lat:34.9972, lon:-80.9265, n:2, cat:'food',
      ...
      price:'$$', tags:['date','outdoor','scenic'] },
    ...
    { lat:35.0228, lon:-80.9782, n:15, cat:'outdoor',
      ...
      tags:['scenic','dogs','outdoor','family'] },
