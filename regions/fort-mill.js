window.REGION = {
  ...
  legend: [
    { color: '#1A4228', label: 'Outdoors' },
    { color: '#B5652A', label: 'Eat &amp; Drink' },
    { color: '#5C3A1A', label: 'Coffee &amp; Wine' },
    { color: '#2A5C3A', label: 'Arts &amp; Wellness' },
    { color: '#4A6A2A', label: 'Family Fun' },
  ],
  ...
  places: [
    ...
    { lat:34.9978, lon:-80.9268, n:1, cat:'food',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/9e/4a/2e/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:34.9972, lon:-80.9265, n:2, cat:'food',
      ...
      meta:'1675 Kingsley Bend · Kingsley · Mon–Thu 4–9pm, Fri–Sat 11am–10pm, Sun 11am–9pm',
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/29/50/5e/8a/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:34.9975, lon:-80.9270, n:3, cat:'food',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2c/1e/3a/5b/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:34.9980, lon:-80.9262, n:4, cat:'coffee',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/2b/3c/4d/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:34.9968, lon:-80.9258, n:5, cat:'food',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2a/1b/2c/3d/caption.jpg?w=900&h=500&s=1' },

    { lat:34.9962, lon:-80.9255, n:6, cat:'food',
      name:'Replay Brewing',
      short:'Craft brewery · NEIPAs · video game vibes',
      desc:'Craft brewery specializing in New England IPAs, sours, lagers, and hard seltzers — all served in a fun video game-themed taproom.',
      meta:'1645 Kingsley Bend · Kingsley · Wed–Thu 3–9pm, Fri 2–10pm, Sat 12–10pm, Sun 12–7pm',
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1c/2d/3e/4f/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0148, lon:-80.9612, n:7, cat:'food',
      ...
      meta:'951 Market St · Baxter Village · Mon–Sat 11am–9pm',
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2d/3e/4f/5a/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0145, lon:-80.9608, n:8, cat:'food',
      ...
      meta:'947 Market St · Baxter Village · Mon–Sat 11am–9pm, Sun 12–8pm',
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1e/2f/3a/4b/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0142, lon:-80.9605, n:9, cat:'food',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2f/3a/4b/5c/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0072, lon:-80.9437, n:10, cat:'coffee',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/3c/5e/7f/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0068, lon:-80.9432, n:11, cat:'coffee',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/4d/6f/8a/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0065, lon:-80.9428, n:12, cat:'food',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1c/4e/6a/8c/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0070, lon:-80.9440, n:13, cat:'food',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2d/5f/7a/9c/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0062, lon:-80.9425, n:14, cat:'coffee',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/3e/6a/8c/ae/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0228, lon:-80.9782, n:15, cat:'outdoor',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0f/be/d2/5c/anne-springs-close-greenway.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0035, lon:-80.9388, n:16, cat:'outdoor',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1b/2c/3d/4e/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:34.9935, lon:-80.9702, n:17, cat:'outdoor',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2c/3d/4e/5f/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0082, lon:-80.9455, n:18, cat:'arts',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/3d/4e/5f/6a/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0058, lon:-80.9420, n:19, cat:'arts',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/4e/5f/6a/7b/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0088, lon:-80.9462, n:20, cat:'family',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/5f/6a/7b/8c/caption.jpg?w=900&h=500&s=1' },
    ...
    { lat:35.0092, lon:-80.9470, n:21, cat:'family',
      ...
      img:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/6a/7b/8c/9d/caption.jpg?w=900&h=500&s=1' },
  ],
