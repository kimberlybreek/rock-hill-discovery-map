window.REGION = {
  ...
  palette: {
    ...
    '--green':        '#1A8A50',
    '--inner-border': '#7ABFAA',
    '--tile-filter':  'saturate(1.3) brightness(1.05) contrast(0.90)',
    '--tile-blend':   'normal',
    '--tile-opa':     '1',
  },
  ...
  legend: [
    { color: '#1A8A50', label: 'Outdoors' },
    { color: '#D42A1A', label: 'Eat &amp; Drink' },
    { color: '#0A5C48', label: 'Coffee &amp; Wine' },
    { color: '#D4921A', label: 'Arts &amp; Wellness' },
    { color: '#5A2A8A', label: 'Family Fun' },
  ],
