window.REGION = {
  ...
  places: [
    ...
    { lat:35.2145, lon:-80.8610, n:11, cat:'coffee',
      ...
      img:'https://images.squarespace-cdn.com/content/v1/589b39c5bebafb6528343d57/1626543818544-XENFWUFQHO2KAMPT1O9B/image-asset.jpeg', bgPosition:'center 70%',
  ...
  landmarks: [
    ...
    { lat: 35.2138, lon: -80.8625, name: 'Parking', type: 'parking' },
    { lat: 35.2070, lon: -80.8598, name: 'Parking', type: 'parking' },
    { lat: 35.2195, lon: -80.8600, name: 'Parking', type: 'parking' },
  ],
