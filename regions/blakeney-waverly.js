window.REGION = {
  ...
  palette: {
    ...
    '--green':        '#2A6848',
    '--inner-border': '#C4A8E0',
    '--tile-filter':  'saturate(1.1) brightness(1.05) contrast(0.92)',
    '--tile-blend':   'normal',
    '--tile-opa':     '1',
  ...
  legend: [
    { color: '#3A7A50', label: 'Outdoors' },
    { color: '#C04870', label: 'Eat &amp; Drink' },
    { color: '#6A3A9A', label: 'Coffee &amp; Wine' },
    { color: '#4A2A7A', label: 'Arts &amp; Wellness' },
    { color: '#2A7A6A', label: 'Family Fun' },
  ],
  ...
  places: [
    ...
    { lat:35.0493, lon:-80.8405, n:2,  cat:'food',
      ...
      price:'$$', tags:['brunch','outdoor','family'] },
  ...
  landmarks: [
    ...
    { lat: 35.0490, lon: -80.8395, name: 'Parking', type: 'parking' },
    { lat: 35.0533, lon: -80.8145, name: 'Parking', type: 'parking' },
  ],
